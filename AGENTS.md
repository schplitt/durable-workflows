...
packages/
  durable-workflows/      # Published as `durable-workflows`
    src/
      ...
      host.ts             # durableWorkflowHost: hydrate({ workflow, plugins, limits }) → runner.execute({ input, cache, globals, limits })
